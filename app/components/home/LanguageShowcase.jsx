...
import {Reveal, MOTION_EASE} from '~/components/motion/Reveal.jsx';
...
export function LanguageShowcase({language = 'english', onLanguageChange}) {
  return (
    <section className="uniinx-home-gutter relative z-10 -mt-7 rounded-t-[28px] bg-white pb-10 pt-8 sm:-mt-[30px] sm:rounded-t-[30px] sm:pb-12 sm:pt-10 lg:-mt-[50px] lg:pb-10">
      <div className="w-full text-left sm:text-center">
        ...
        >
          {SHOWCASE_LANGUAGES.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <motion.span
                  ...
                  className="absolute inset-x-0 bottom-0 h-px origin-left bg-black"
                />
              </motion.button>
            );
          })}
